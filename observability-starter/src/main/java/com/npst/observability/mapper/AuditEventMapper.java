...
/**
 * Audit event to wire contract.
 *
 * <p>Unlike {@link LogEventMapper}, nothing here is masked. The audit trail is
 * the one place identity has to survive intact - the masked copy is what goes
 * to the log file and on to Loki.
 */
